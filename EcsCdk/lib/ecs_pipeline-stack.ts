...
export class EcsPipelineStack extends cdk.Stack {
  ...
  constructor(scope: cdk.App, id: string, props: EcsStackProps) {
    ...
    //   actionName: 'Source_Checkout',
    //   connectionArn: 'arn:aws:codeconnections:ap-northeast-1:xxxxxxxxxxxx:connection/xxxxxxxxxxx', // CodeConnectionsのARNを指定
    //   owner: 'xxx', // GitHubユーザー名または組織名
    //   repo: 'xxx', // GitHubリポジトリ名
    //   branch: 'main', // トリガーするブランチ名
    //   output: sourceOutput,
    // });

    // const sourceAction = new codepipeline_actions.CodeStarConnectionsSourceAction({
    //   actionName: 'Source_Checkout',
    //   connectionArn: 'arn:aws:codeconnections:ap-northeast-1:xxxxxxxxxxxx:connection/xxxxxxxxxx', // CodeConnectionsのARNを指定
    //   owner: 'xxx', // Gitlabユーザー名または組織名
    //   repo: 'xxx', // Gitlabリポジトリ名
    //   branch: 'main', // トリガーするブランチ名
    //   output: sourceOutput,
    // });
    ...
    //myKmsKey.applyRemovalPolicy(RemovalPolicy.DESTROY);
